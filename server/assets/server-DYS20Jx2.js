...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C_hfiQt8.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DP6i0Jxe.js"),
    import("./start-DbySBJvY.js"),
...
var ROUTER_BASEPATH = "karabo-cape-cuts-main";
var SERVER_FN_BASE = "/karabo-cape-cuts-main/_serverFn/";
